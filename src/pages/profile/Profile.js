            ...
            <div className="flex-auto flex-col h-full">
                ...
                {windowSize.innerWidth < 768 && !hidden ?    
                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8 border-2 px-4">
                            <div id="profile" className="w-full rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 lg:mx-0 pt-20">
                                <div className="p-4 md:p-12 text-center lg:text-left">
                                    ...
                                    <div className="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-green-500 opacity-25"></div>
                                        ...
                                        <path strokeLinecap="round" d="M16.5 12a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0zm0 0c0 1.657 1.007 3 2.25 3S21 13.657 21 12a9 9 0 10-2.636 6.364M16.5 12V8.25" /></svg>{ sessionData.user.email }</p>
                                        <p className="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
