...
export default function Input({type, identifier, tittle, placeholder, required}){
    return (
        <>
            <label htmlFor={ identifier } className="block mb-2 text-lg font-medium text-mercury-600 dark:text-gray-300">{ tittle } {required ? <s className="text-radical-red-600">*</s> : null}</label>
